    ...
    <AnimatePresence mode="wait">
      {visible && (
        <motion.div
          ...
          className={cn(
            "flex sm:max-w-5xl w-full justify-self-center backdrop-blur-md fixed top-0 sm:top-4 inset-x-0 mx-auto md:rounded-lg sm:bg-none dark:bg-background/10 sm:dark:bg-background/20 bg-white/30 z-[5000] pr-4 pl-6 py-4 items-center justify-between",
            className
          )}
